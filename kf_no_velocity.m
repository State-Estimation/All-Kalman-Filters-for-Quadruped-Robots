...
R = [eye(3)*0.1,zeros(3),zeros(3),zeros(3),zeros(3, 4);
     zeros(3),eye(3)*0.1,zeros(3),zeros(3),zeros(3, 4);
     zeros(3),zeros(3),eye(3)*0.01,zeros(3),zeros(3, 4);
     zeros(3),zeros(3),zeros(3),eye(3)*0.01,zeros(3, 4);
     zeros(4,3),zeros(4,3),zeros(4,3),zeros(4,3),eye(4)*0.001];     % 观测噪声协方差矩阵 %25
Q = [eye(3)*0.01,zeros(3),zeros(3),zeros(3),zeros(3),zeros(3);
...
save('KF.mat', 'outcome_kf');
% 将 outcome_luen_luen 保存为 TXT 文件
writematrix(outcome_kf, 'IDL+IK', 'Delimiter', ' ');
